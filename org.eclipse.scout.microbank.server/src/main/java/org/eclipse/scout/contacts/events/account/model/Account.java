...
public class Account {
  ...
  public Account(String personId, String name, String password, String pathToFile) {
    ...
    try {
      boolean useFullScrypt = true;
      fileName = WalletUtils.generateNewWalletFile(password, new File(pathToFile), useFullScrypt);
...
//      Credentials credentials = Credentials.create(keyPair);
  ...
  public Transaction createSignedTransaction(String to, BigInteger amountWei, BigInteger nonce, BigInteger gasPrice, BigInteger gasLimit) {
    Transaction tx = new Transaction(to, amountWei, nonce, gasPrice, gasLimit);
