...
import org.eclipse.scout.contacts.client.account.AccountForm.MainBox.CancelButton;
import org.eclipse.scout.contacts.client.account.AccountForm.MainBox.OkButton;
import org.eclipse.scout.contacts.client.account.AccountForm.MainBox.TopBox;
import org.eclipse.scout.contacts.client.account.AccountForm.MainBox.TopBox.AddressField;
import org.eclipse.scout.contacts.client.account.AccountForm.MainBox.TopBox.FileContentField;
import org.eclipse.scout.contacts.client.account.AccountForm.MainBox.TopBox.FilePathField;
import org.eclipse.scout.contacts.client.account.AccountForm.MainBox.TopBox.NameField;
import org.eclipse.scout.contacts.client.account.AccountForm.MainBox.TopBox.PasswordField;
import org.eclipse.scout.contacts.client.account.AccountForm.MainBox.TopBox.PasswordVisibleField;
import org.eclipse.scout.contacts.client.account.AccountForm.MainBox.TopBox.PersonField;
import org.eclipse.scout.contacts.client.account.AccountForm.MainBox.TopBox.QrCoceField;
...
public class AccountForm extends AbstractForm {
	...
	public class MainBox extends AbstractGroupBox {
		...
		public class TopBox extends AbstractGroupBox {
			...
			public class FileContentField extends AbstractStringField {
				@Override
				protected String getConfiguredLabel() {
					return TEXTS.get("WalletContent");
				}
	...
	public class ModifyHandler extends AbstractFormHandler {
		...
		protected void execLoad() {
			...
			getForm().setTitle(calculateTitle());
		}
	...
	private String calculateTitle() {
		String title = getConfiguredTitle();
		String person = getPersonField().getDisplayText();
		String account = String.format("(%s)", getNameField().getValue());
		
		if(StringUtility.hasText(account)) {
			String accountInfo = StringUtility.join(" ", person, account);
			return String.format("%s - %s", title, accountInfo);
		}
		else if(StringUtility.hasText(person)) {
			return String.format("%s - %s", title, person);
		}
